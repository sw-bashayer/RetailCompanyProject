...
namespace RetailCompanyProject.Controllers
{
    public class LaptopsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Color,Screen,Price,Quantity,ImageURL")] Laptop laptop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Color,Screen,Price,Quantity,ImageURL")] Laptop laptop)
        {
            if (id != laptop.Id)
            {
                return NotFound();
